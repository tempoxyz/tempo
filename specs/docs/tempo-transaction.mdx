...
More information about Access Keys can be found in the [Account Keychain Specification](/protocol/specs/account-keychain).
...
**See the [Account Keychain Specification](/protocol/specs/account-keychain) for complete interface details, storage layout, and implementation.**
