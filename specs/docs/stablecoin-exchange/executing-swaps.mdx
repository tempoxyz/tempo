...
For complete details on checking balances, depositing, withdrawing, and managing your exchange balance, see the [Exchange Balance](/protocol/specs/stablecoin-exchange/exchange-balance) page.