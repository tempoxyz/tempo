...
The storage credit accounting state MUST be ordinary protocol state. Creating or updating the storage credit counter, including the first creation of that counter's backing storage slot, MUST NOT itself mint or consume storage credits and MUST NOT incur the 250,000 gas TIP-1000-mandated storage creation cost.
...
6. The storage credit accounting writes do not mint or consume storage credits and do not incur the TIP-1000 storage creation cost.
