...
Implementations MUST NOT persist the epoch alongside the committee members. The epoch returned by `getCommitteeMembers()` is derived from the current block context.
