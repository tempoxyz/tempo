...
A recovery authority designated by the receiver, which could be the receiver, the originator, or a third-party recovery authority can claim those funds later. Each blocked transfer record keeps enough information to identify the original transfer, so it can be handled correctly.
