...
| EIP-7702 delegation pricing | 12,500 gas (base) + 250,000 (nonce 0) | 250,000 gas (25,000 regular + 225,000 state) + 250,000 (nonce 0) |
| State gas counts toward user's gas_limit | Yes | Yes (no change) |
| State gas counts toward protocol limits | Yes | No (exempt via reservoir model) |
| Regular gas counts toward protocol limits | Yes | Yes (no change) |
