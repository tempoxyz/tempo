...
| | Regular Gas | State Gas | Total |
|---|-------------|-----------|-------|
| Transfer logic | ~50,000 | 0 | ~50,000 |
| New balance slot | 20,000 | 230,000 | 250,000 |
| **Total** | **~70,000** | **230,000** | **~300,000** |

| Property | Value |
|----------|-------|
| User `gas_limit` | ≥ 300,000 |
| Counts toward block limit | ~70,000 (regular gas only) |
...
| Property | Value |
|----------|-------|
| User `gas_limit` | ≥ 50,000 |
| Counts toward block limit | ~50,000 (regular gas only) |
...
| Scenario | Regular Gas / tx | Transfers / block | TPS |
|----------|-----------------|-------------------|-----|
| New account transfers | ~70k | ~7,150 | ~14,300 |
| Existing account transfers | ~50k | ~10,000 | ~20,000 |
| TIP-1000 new account (no exemption) | ~300k | ~1,700 | ~3,400 |

Only regular gas constrains block capacity. State gas is exempt from block limits.
