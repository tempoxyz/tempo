...
status: Backlog
related: TIP-1028, TIP-1034, TIP-1096, TIP-1121
protocolVersion: TBD
---
...
2. **Protected Addresses**: Reverts with `ProtectedAddress` if `from` is in the protected set shared with `burnBlocked`. At activation that set is:
   ...
   - Any Zone portal, identified by the 12-byte address prefix `0x5AD0000000000000000000` from [TIP-1096](./tip-1096.md)
