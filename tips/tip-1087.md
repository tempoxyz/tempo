...
Orderbooks keep their existing logical shape and gain a persisted book index in the same slot as the best-tick cache:
...
slot 4:
  ...
  offset 4   idFlag       bool      1 byte
  offset 5   id           uint32    4 bytes
...
function bookIndexForKey(bytes32 bookKey) external view returns (bool indexed, uint32 index);
