...
- Tooling MUST support the T11 signature encodings, signed key authorization shape, and precompile ABI and events; address derivation SHOULD use `deriveAccount`.
