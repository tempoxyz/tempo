...
An account may store up to 58 owners, but a transaction may submit at most 8 approvals. Each approval has a byte limit. Configurable account approvals may nest once: the outer account is depth 1 and its initialized owner account is depth 2.
