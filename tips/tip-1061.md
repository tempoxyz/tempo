...
- T11 activates consensus acceptance and validation of multisig signatures, the native multisig precompile, and the signed key authorization changes together. Inconsistent activation would make nodes disagree about transaction validity.
