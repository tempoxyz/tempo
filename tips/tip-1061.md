...
An account may store up to 58 owners, but each configurable account signature may contain at most 8 owner signatures. Primitive owner signatures have a byte limit. Owner signatures may nest once: the outer account is depth 1 and its initialized owner account is depth 2.
