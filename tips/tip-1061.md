...
Signature type `0x05` uses a bootstrap shape for new accounts and an initialized shape for existing accounts.
...
- **Configurable account fee payer.** Fee-payer validation MUST reject configurable signatures and initialized configurable account addresses.
