...
- Future TIPs MAY add access key support for native multisig accounts.
- Multisig accounts MUST NOT support access keys bound to `msg.sender` equal to the multisig account.
