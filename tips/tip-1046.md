...
## 6. Pre-charge gas before cold loads in storage and account access
...
## 7. Skip redundant SLOAD on packed-struct stores
...
## 8. Allow omitting empty subblocks metadata system transaction
