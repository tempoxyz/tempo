...
The existing charge underprices some dynamic input decoding. Increasing it
improves denial-of-service resistance with negligible overhead for normal calls.
