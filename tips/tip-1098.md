...
header, and payload; its Serde encoder constructs `Sig_structure`. Validation operates on decoded
values and retains map entries to detect duplicate fields and PCR indices. `minicbor` is used
