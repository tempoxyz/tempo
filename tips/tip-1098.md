...
(fallback) to bypass Nitro verification checks. Operators SHOULD use fallback only after a previous
Nitro verification failed with `InvalidProof`. A later hardfork MUST disable fallback mode,
