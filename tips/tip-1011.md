...
22. For constrained TIP-20 selectors (`transfer`, `approve`, `transferWithMemo`, `approveWithMemo`), calls succeed iff calldata argument `0` is in the configured recipient set.
