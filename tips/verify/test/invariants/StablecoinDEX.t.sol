...
/// Pinned to T12 so TEMPO-DEX7 covers quote/swap parity.
/// forge-config: default.hardfork = "tempo:T12"
/// forge-config: fuzz500.hardfork = "tempo:T12"
contract StablecoinDEXInvariantTest is InvariantBaseTest {
    ...
    function _swapExactAmountIn(
        ...
        internal
    {
        // TEMPO-DEX7: Quote should match execution (T12+).
        uint128 quotedOut;
        bool quoteSucceeded;
        ...
        try exchange.swapExactAmountIn(
            ...
            // TEMPO-DEX7: Quote matches execution (T12+).
            if (quoteSucceeded) {
