...
selected for activation. The activation configuration MUST record the revision
and source deployment address.
...
binaries. The `ZonePortal` implementation and shared messenger MUST use
