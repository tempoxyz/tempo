...
#### Illustrative T10 Upgrade

The following source addresses are arbitrary placeholders that demonstrate a
later hardfork upgrade and MUST be replaced before T10 is scheduled:

- portal: `0xa5c4cf2602a892565ac368e91ba0431ec8fefddf`
- verifier: `0xfb556b33f9eb532054a31be32f83ec19ad60c1a7`
- messenger: `0x3e4dd4c72df468a72df9c079c79be3dbf05fa79b`

When T10 becomes active, the block transition copies the runtime at each source
to its corresponding protocol-managed address. It loads and validates all
three non-empty runtimes before applying one atomic state commit. Re-execution
is idempotent when the destination code hashes already match their sources.
...
the initial configuration above and install the three shared runtimes as
described in Shared Runtime Management.
