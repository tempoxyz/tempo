 ...
 * [Erasure Coding](https://github.com/commonwarexyz/monorepo/blob/main/consensus/src/marshal/coding/mod.rs) which makes more efficient use of the network's bandwidth by spreading the load of block dissemination.

By embedding the context into the header, Tempo blocks can implement required [CertifiableBlock](https://github.com/commonwarexyz/monorepo/blob/2a588e4e341548333a4bd753c016e814ae0ecca0/consensus/src/lib.rs#L57) trait.
