...
* The migration to `Deferred` implies that the notarization certified will no longer carry any guarantees on the validity of the block. Only ensuring the consensus view is valid.
