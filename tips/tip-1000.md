...
**Impact:** The first transaction from a new account increases from 0.1 cents (1,000 microdollars) to 0.6 cents (6,000 microdollars), representing a 6x increase. Combined with the initial transfer cost (0.6 cents / 6,000 microdollars), the total onboarding cost for a new user is approximately 1.2 cents (12,000 microdollars).
