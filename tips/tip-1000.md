...
**Impact:** A transfer to a new address increases from 0.14 cents (1,400 microdollars) to 0.6 cents (6,000 microdollars), representing a 4.3x increase. The account creation cost (0.5 cents / 5,000 microdollars) will be charged separately when the recipient first uses their account.
