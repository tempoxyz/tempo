...
- **Microdollars (μ$)**: TIP-20 token units at 10^-6 USD precision (6 decimals). One TIP-20 token unit = 1 microdollar = 0.000001 USD = 0.0001 cents.

- **Attodollars (a$)**: Gas accounting units at 10^-18 USD precision. Gas prices (basefee) are denominated in attodollars.
...
- TIP-20 transfer cost (to existing address, including base transaction and state update): 50,000 gas = 0.1 cent (100,000 microdollars)
- Implied gas price: 1 cent per 500,000 gas (10 million microdollars per 500,000 gas)

**New State Element Creation:**
- Gas cost: 250,000 gas
- Dollar cost: 250,000 / 500,000 = **0.5 cents (5,000,000 microdollars) per state element**

**Account Creation:**
- Gas cost: 250,000 gas
- Dollar cost: 250,000 / 500,000 = **0.5 cents (5,000,000 microdollars) per account**

**Contract Creation:**
- Per byte: 1,000 gas = **0.002 cents (20,000 microdollars) per byte**
- Keccak + codesize fields: 500,000 gas (2 × 250,000) = **1.0 cent (10,000,000 microdollars)**
- Example: 1,000 byte contract = (1,000 × 1,000) + 500,000 = 1,500,000 gas = **3.0 cents (30,000,000 microdollars)**
...
- **Total: ~70,000 gas ≈ 0.14 cents (1,400,000 microdollars)**
...
- **Total: ~300,000 gas ≈ 0.6 cents (6,000,000 microdollars)**
- Note: Account creation cost does not apply here because the recipient's nonce remains 0

**Impact:** A transfer to a new address increases from 0.14 cents (1,400,000 microdollars) to 0.6 cents (6,000,000 microdollars), representing a 4.3x increase. The account creation cost (0.5 cents / 5,000,000 microdollars) will be charged separately when the recipient first uses their account.
...
- **Total: 50,000 gas ≈ 0.1 cents (1,000,000 microdollars)**
...
**Impact:** The first transaction from a new account increases from 0.1 cents (1,000,000 microdollars) to 0.6 cents (6,000,000 microdollars), representing a 6x increase. Combined with the initial transfer cost (0.6 cents / 6,000,000 microdollars), the total onboarding cost for a new user is approximately 1.2 cents (12,000,000 microdollars).
...
- Example for 1,000 byte contract: 32,000 + (1,000 × 200) = 232,000 gas ≈ 0.46 cents (4,640,000 microdollars)

**Proposed Cost:**
- Account creation: 250,000 gas
- Contract code storage: code_size × 1,000 gas
- Keccak + codesize fields: 500,000 gas (2 × 250,000)
- Example for 1,000 byte contract: 250,000 + (1,000 × 1,000) + 500,000 = 1,750,000 gas ≈ **3.5 cents (35,000,000 microdollars)**

**Impact:** Contract deployment costs increase significantly, especially for larger contracts. A 100 byte contract costs (100 × 1,000) + 500,000 + 250,000 = 850,000 gas = 1.7 cents (17,000,000 microdollars) total.
