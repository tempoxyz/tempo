...
3. The transaction uses no more than 250,000 gas. Since 250,000 gas is the cost of a new state write, this enforces the discount to apply only to transactions that do not create new state. 
