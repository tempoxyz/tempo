...
interface IAddressRegistry {
    ...
    /// @notice Returns true if the address is on the active TIP-1035 Implicit Approval List.
    ///         Returns false before TIP-1035 activates.
...
Contracts or integrators that need a canonical hardfork-aware query for TIP-1035 spender status MAY call `isImplicitlyApproved` on the registry.
