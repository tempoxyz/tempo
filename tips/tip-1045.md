...
| TIP20ChannelReserve | `open(address,address,uint96,bytes32,address,uint32)` | Open channel |
| TIP20ChannelReserve | `topUp((address,address,address,bytes32,address),uint96,uint32)` | Top up channel |
| TIP20ChannelReserve | `settle((address,address,address,bytes32,address),uint96,bytes)` | Settle channel |
| TIP20ChannelReserve | `close((address,address,address,bytes32,address),uint96,uint96,bytes)` | Close channel |
