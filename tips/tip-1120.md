...
charge shared cost budget for this original-input consumption, or revert
...
The `TIP20Factory` precompile implements the following `fund`:
...
The `EarnFactory` contract implements the following `fund`:
