// Usage: node compile.cjs /path/to/solc/package [ContractName]
...
const name = process.argv[3] || 'GasCalibration';
if (!/^[A-Za-z][A-Za-z0-9]*$/.test(name)) throw Error('Expected a contract name');
