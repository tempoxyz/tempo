...
| Corrected fixed-lookahead 16/32 comparison | [35219652510](https://github.com/tempoxyz/tempo/actions/runs/35219652510): capture completed; controller rejected legacy absent observer metadata represented as null. Source inspection proves the leaf observer was absent. | Performance acceptance pending reviewed compatibility fix and all audits. Preserve original rejection; no redispatch justified. |
...
| Inline singleton storage proofs | [35202318927](https://github.com/tempoxyz/tempo/actions/runs/35202318927): ownership-corrected comparison; replay-through-verification p90 +5.02%/+9.18%. | No repeated node benefit. |
| Borrow builder context | [35210439349](https://github.com/tempoxyz/tempo/actions/runs/35210439349), [PR7688](https://github.com/tempoxyz/tempo/pull/7688): local allocation traffic -672 bytes/job; node replay-through-verification p90 +17.25%/-11.94%. | Local saving; node benefit inconclusive. |
| Borrow engine tracing parent | [35211480399](https://github.com/tempoxyz/tempo/actions/runs/35211480399), [PR7690](https://github.com/tempoxyz/tempo/pull/7690): local CPU reduction; node replay-through-verification p90 -10.84%/+0.71%. | No repeated gain. |
| Borrow builder command sender | [35215249258](https://github.com/tempoxyz/tempo/actions/runs/35215249258), [PR7693](https://github.com/tempoxyz/tempo/pull/7693): local CPU reduction; node block p90 -5.09%/+15.88%. | No repeated gain. |
