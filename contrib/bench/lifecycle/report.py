...
def build(paths, warmup=5, window=None, expected_detail=None, expected_async_tasks=None):
    ...
    bad_capture = not tasks_valid or not detail_valid or any(not q['header'] or not q['footer'] or q['dropped'] or q['io_error'] or q['invalid_lines'] or q['open_spans'] for q in quality)
