...
<Card.Notice
  ...
  inline
>
  <p><a href="/quickstart/faucet">Click here</a> to deposit funds directly into your wallet.</p>
</Card.Notice>
...
<Card.Container>
  <Card.Link
    ...
    description={
    "Learn how to connect to the Tempo with your wallet or programmatically."
    }
