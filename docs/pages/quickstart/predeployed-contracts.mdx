...
|----------|---------|-------------|
| [**TIP-20 Factory**](/documentation/protocol/tip20/overview) | `0x20fc000000000000000000000000000000000000` | Create new TIP-20 tokens |
| [**Fee Manager**](/documentation/protocol/fees/spec-fee-amm#2-feemanager-contract) | `0xfeec000000000000000000000000000000000000` | Handle fee payments and conversions |
| [**Stablecoin Exchange**](/documentation/protocol/exchange) | `0xdec0000000000000000000000000000000000000` | Enshrined DEX for stablecoin swaps |
| [**TIP-403 Registry**](/documentation/protocol/tip403/spec) | `0x403c000000000000000000000000000000000000` | Transfer policy registry |
| [**pathUSD**](/documentation/protocol/exchange/pathUSD) | `0x20c0000000000000000000000000000000000000` | First stablecoin deployed |
...
| [**Ithaca Account**](https://github.com/tempo-labs/ithaca-account) | `0x7702c00000000000000000000000000000000000` | Account abstraction contract |
