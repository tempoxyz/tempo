...
:::tip
Check out Privy's [example](https://github.com/privy-io/examples/tree/main/examples/privy-next-tempo) of a p2p payments app that makes use of Tempo's transaction memos.
:::
