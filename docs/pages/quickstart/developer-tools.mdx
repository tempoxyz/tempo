...
[Privy](https://www.privy.io) makes it easy to onboard users with familiar login methods while giving each user a secure, self-custodial wallet behind the scenes. Developers can integrate authentication and embedded wallets in minutes, enabling smooth Tempo-native experiences without exposing users to seed phrases.

Get started by enabling Tempo support in the [Privy dashboard](https://dashboard.privy.io) and following the setup guides in the [Privy docs](https://docs.privy.io/basics/get-started/).
...
[Create your Turnkey account](https://app.turnkey.com/dashboard) and follow the [Embedded Wallet Kit quickstart](https://docs.turnkey.com/getting-started/embedded-wallet-kit) to add Turnkey-powered wallets to your Tempo app.
