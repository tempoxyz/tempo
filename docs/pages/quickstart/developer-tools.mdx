...
[Privy](https://www.privy.io/) builds secure key management and onboarding for embedded wallets so any developer can easily build secure, scalable wallets into their app. Easily spin up self-custodial wallets for users, manage your treasury wallets and more in minutes.

Privy takes advantage of Tempo-native experiences to enable better stablecoin and payments applications further enabling gas sponsorship, callbacks from chain events, delegated signatures, simple wallet funding and more.
