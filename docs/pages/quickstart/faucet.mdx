...
<Demo.Container name="Use the Faucet" footerVariant="balances" tokens={[Token.pathUsd, Token.alphaUsd, Token.betaUsd, Token.thetaUsd]} src="tempoxyz/tempo-ts/tree/main/examples/payments">
  <Step.ConnectWallet stepNumber={1} />
  <Step.AddFunds stepNumber={2} fundOthers />
