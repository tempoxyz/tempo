...
See [Connection Details](/quickstart/connection-details#direct-connection-details) for the full configuration. If you need assistance migrating, reach out to us at [partners@tempo.xyz](mailto:partners@tempo.xyz).