...
<Callout type="warning">
  **Andantino testnet deprecation:** We're launching a new testnet **Moderato** on January 8th. Andantino will be deprecated on March 8th. You'll need to update your chain config (chain ID: `42431`, RPC: `rpc.moderato.tempo.xyz`) and redeploy any contracts. See [Connection Details](/quickstart/connection-details) for the new configuration.
</Callout>
