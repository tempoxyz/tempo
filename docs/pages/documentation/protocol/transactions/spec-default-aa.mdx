...
:::warning
**Note: This feature will likely be deprecated before mainnet launch.** We recommend using the standard [account abstraction transaction type](/documentation/protocol/transactions/spec-account-abstraction) instead if you need smart contract functionality.
:::
