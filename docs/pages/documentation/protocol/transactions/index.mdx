...
Tempo includes a new EIP-2718 transaction type (`0x76`), the `TempoTransaction`, providing features like passkey, call batching, scheduled and parallel transactions, and fee sponsorship natively into the protocol.
...
<Card.Container>
  <Card.Link
    ...
    href="/documentation/protocol/transactions/spec-tempo-transaction"
    icon={LucideFileCode}
    title="Specification"
  />
  <Card.Link
