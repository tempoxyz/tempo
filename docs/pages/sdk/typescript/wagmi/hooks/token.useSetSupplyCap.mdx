...
Sets the supply cap for a TIP-20 token. Requires appropriate permissions. [Learn more about roles](/documentation/protocol/tip20/spec#role-based-access-control)
