...
description: Execute transactions within specific time windows using validAfter and validBefore timestamps. Enable vesting schedules and time-limited offers.
---
