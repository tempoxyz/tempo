...
description: Enable gasless transactions by sponsoring fees for users. Learn how applications can pay gas costs on behalf of users using Tempo Transactions.
---
