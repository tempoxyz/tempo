...
description: Sign Tempo transactions with multiple signature types including secp256k1, P256, and WebAuthn for passkeys, Face ID, Touch ID, and hardware keys.
---
