...
<Callout type="info">
Additional signature types may be supported in the future. For complete technical specifications, see the [Tempo Transaction](/documentation/protocol/transactions/spec-tempo-transaction) protocol documentation.
</Callout>
