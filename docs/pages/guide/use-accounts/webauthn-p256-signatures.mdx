...
<Callout type="info">
Additional signature types may be supported in the future. For complete technical specifications, see the [Account Abstraction](/documentation/protocol/transactions/spec-account-abstraction) protocol documentation.
</Callout>
