...
<Callout type="info">
  Batch transactions are a feature of Tempo's [Account Abstraction transaction type](/documentation/protocol/transactions/spec-account-abstraction). See the AA transaction spec for complete details on batching and other AA features.
</Callout>
