...
<Callout type="info">
  Batch transactions are a feature of Tempo's [TempoTransaction type](/documentation/protocol/transactions/spec-account-abstraction). See the TempoTransaction spec for complete details on batching and other features.
</Callout>
