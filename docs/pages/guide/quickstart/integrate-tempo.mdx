...
Tempo targets the **Osaka** EVM hard fork with support for new payments-specific [protocols](/documentation/protocol/) and [smart contracts](/guide/quickstart/predeployed-contracts). See below for how to integrate Tempo into your application, wallet or infrastructure.
