...
function Buy() {
  ...
  // How much DONOTUSE do I need to spend to receive 10 BetaUSD? // [!code hl]
  const { data: quote } = Hooks.dex.useBuyQuote({ // [!code hl]
    tokenIn: DONOTUSE, // [!code hl]
...
function Sell() {
  ...
  // How much BetaUSD will I receive for 10 DONOTUSE? // [!code hl]
...
function Buy() {
  ...
  // How much DONOTUSE do I need to spend to receive 10 BetaUSD?
...
function Sell() {
  ...
  // How much BetaUSD will I receive for 10 DONOTUSE?
