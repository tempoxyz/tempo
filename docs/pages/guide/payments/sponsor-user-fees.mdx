...
:::tip
Tempo provides a public testnet fee payer service at `https://sponsor.tempo.xyz` that you can use for development and testing. If you want to run your own, follow the instructions below.
:::
