...
<Demo.Container name="Receive a Payment" footerVariant="balances" tokens={[Token.DONOTUSE, Token.betaUsd, Token.thetaUsd]} src="tempoxyz/tempo-ts/tree/main/examples/payments">
...
const unwatch = watchEvent(client, {
  address: '0x20c000000000000000000000033abb6ac7d235e5',
  event: {
    type: 'event',
    name: 'Transfer',
    inputs: [
