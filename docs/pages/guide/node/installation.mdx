...
curl -L https://testnet-assets.tempoxyz.dev/binaries/v0.7.0/tempo-v0.7.0-x86_64-unknown-linux-gnu.tar.gz -o tempo.tar.gz
...
docker pull ghcr.io/tempoxyz/tempo:0.7.0

# Run the Docker container
docker run -d --name tempo ghcr.io/tempoxyz/tempo:0.7.0 --version
docker logs tempo
```
