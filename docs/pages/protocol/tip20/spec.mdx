...
interface ITIP20 {
    ...
    /// @dev From Allegretto hardfork onwards, validates that the policy exists using TIP403Registry.policyExists()
...
interface ITIP20Factory {
    ...
    ///    where lowerBytes is the highest 80 bits of keccak256(msg.sender, salt)
