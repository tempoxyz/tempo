...
- **Protocol Version**: Mainnet Launch
...
**Value**: 25,000,000 gas per block (`general_gas_limit`)
...
- Sized to prevent state growth attacks while enabling reasonable contract activity
...
- Accommodates deployment of maximum-size contracts (24KB) under TIP-1000 state creation costs:
  - Contract code: `24,000 bytes × 1,000 gas/byte = 24,000,000 gas`
  - Keccak + codesize fields: 500,000 gas
  - Account creation: 250,000 gas
  - Base transaction cost: ~21,000 gas
  - **Total**: ~24,771,000 gas (fits within 30M limit)
...
| General gas limit | 25,000,000 gas/block | General contract interactions |
...
| Small contract deployment (1KB) | ~1,750,000 | $0.035 (3.5 cents) |
| Max contract deployment (24KB) | ~24,750,000 | $0.495 (~50 cents) |
