# Burn At for TIP-20 Tokens

This document specifies the `burnAt` function for TIP-20 tokens, enabling authorized administrators to burn tokens from any address.

- **TIP ID**: TIP-1006
- **Authors/Owners**: @dan
- **Status**: Draft
- **Related Specs/TIPs**: TIP-20
...
There are legitimate use cases where token administrators need to burn tokens from any address regardless of their policy status, such as:
