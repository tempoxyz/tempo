...
### 4. Payment Lane Capacity

At mainnet launch, the payment lane gas limit is set to 500,000,000 gas per block, allowing approximately 10,000 TIP-20 transfers per block and supporting approximately 20,000 transactions per second throughput.
