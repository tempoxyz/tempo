...
**Gas:**
- Charge identical total gas as a 7702 delegation on Tempo (i.e., `ecrecover` cost + code-installation cost consistent with 7702). The exact numeric schedule is inherited from 7702 on Tempo.
