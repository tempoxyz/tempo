...
|------------|-------------|
| [**Limit Orders**](/protocol/exchange/providing-liquidity#limit-orders) | Place resting orders at specific price levels that remain in the book until matched or cancelled. New orders respect price‑time priority. |
| [**Flip Orders**](/protocol/exchange/providing-liquidity#flip-orders) | Special orders that automatically reverse to the opposite side when completely filled, acting like a perpetual liquidity pool. Filled flip orders create new orders on the opposite side at the configured flip tick. |
