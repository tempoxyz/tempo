...
For complete details on checking balances, depositing, withdrawing, and managing your DEX balance, see the [Exchange Balance](/protocol/exchange/exchange-balance) page.