...
The DEX allows you to hold token balances directly on the DEX contract to avoid transfer costs. When placing orders, tokens are debited from your exchange balance (or transferred from your wallet if insufficient). When your orders fill, proceeds are credited to your DEX balance.
