...
mod tests {
    ...
    fn reth_state_root_with_flat_trie_cursors() {
        ...
        for a in [3u64, 77, 200, 399] {
            ...
            ops2.push((key, StateOp::SetAccount {
                nonce: a + 1000,
            ...
            ops2.push((key, StateOp::SetStorage {
                slot,
        ...
        let mut storage_prefixes: alloy_primitives::map::B256Map<reth_trie::prefix_set::PrefixSet> = Default::default();
        ...
        .root()
        .unwrap();
        assert_eq!(reth_root.0, flat_root2, "incremental root over flat trie cursors mismatch");
    }
}
...
impl<'m> TrieCursorFactory for FlatTrieCursorFactory<'m> {
    ...
    fn account_trie_cursor(&self) -> Result<Self::AccountTrieCursor<'_>, DatabaseError> {
        Ok(FlatAccountTrieCursor { inner: self.mpt.trie_node_cursor(), current: None })
    }
