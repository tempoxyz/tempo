...
use tempo_chainspec::spec::TEMPO_BASE_FEE_PRE_T1;
    ...
    P: Provider + Clone,
{
    ...
    let sign_and_encode = |mut tx_req: TransactionRequest, nonce: u64| {
        ...
        async move {
            ...
            tx_req.max_fee_per_gas = tx_req.max_fee_per_gas.or(Some(TEMPO_BASE_FEE_PRE_T1 as u128));
            tx_req.max_priority_fee_per_gas = tx_req
                .max_priority_fee_per_gas
                .or(Some(TEMPO_BASE_FEE_PRE_T1 as u128));
    ...
    P: Provider + Clone,
{
    ...
    for i in 0..count {
        ...
        tx_request.max_fee_per_gas = Some(TEMPO_BASE_FEE_PRE_T1 as u128);
        tx_request.max_priority_fee_per_gas = Some(TEMPO_BASE_FEE_PRE_T1 as u128);
