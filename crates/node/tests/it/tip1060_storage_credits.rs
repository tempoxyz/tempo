...
use tempo_contracts::precompiles::{
    DEFAULT_FEE_TOKEN, IFeeManager, ITIP20, ITIP20ChannelReserve, ITIP1060StorageCredits,
...
async fn test_tip1066_channel_storage_credits_are_payer_scoped() -> eyre::Result<()> {
    ...
    let storage_credits = ITIP1060StorageCredits::new(STORAGE_CREDITS_ADDRESS, &provider);
