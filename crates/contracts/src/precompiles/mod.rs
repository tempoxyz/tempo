...
pub mod funding_policy_registry;
...
pub use funding_policy_registry::*;
...
pub const TIP20_FUNDER_ADDRESS: Address = address!("0xffffffffffffffffffffffffffffffffffff1120");
pub const NATIVE_DEX_FUNDING_SOURCE_ADDRESS: Address =
    address!("0x0000000000000000000000000000000000001121");
