...
pub const TIP20_FUNDER_ADDRESS: Address = address!("0x1120000000000000000000000000000000000000");
pub const NATIVE_DEX_FUNDING_SOURCE_ADDRESS: Address =
    address!("0x1120000000000000000000000000000000000001");
pub const FUNDING_POLICY_ADDRESS: Address = address!("0x1120000000000000000000000000000000000002");
...
pub const SYSTEM_PRECOMPILES: &[(Address, TempoHardfork)] = &[
    ...
    (TIP20_FUNDER_ADDRESS, TempoHardfork::T13),
    (FUNDING_POLICY_ADDRESS, TempoHardfork::T13),
    (NATIVE_DEX_FUNDING_SOURCE_ADDRESS, TempoHardfork::T13),
];
