...
pub const NITRO_ATTESTATION_VERIFIER_ADDRESS: Address =
    address!("0xA77E570000000000000000000000000000000000");
...
pub const SYSTEM_PRECOMPILES: &[(Address, TempoHardfork)] = &[
    ...
    (NITRO_ATTESTATION_VERIFIER_ADDRESS, TempoHardfork::T9),
];
