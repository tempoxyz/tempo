...
- Added a helper for constructing the complete native ZoneFactory state with a specified initial owner. (by @TanishkGoyal, [#7080](https://github.com/tempoxyz/tempo/pull/7080))
- Added the `LeaderUpdated` event and updated the ZonePortal runtime with leader transition support. (by @TanishkGoyal, [#7080](https://github.com/tempoxyz/tempo/pull/7080))
...
- Implemented TIP-1091 with a native permissioned ZoneFactory, deterministic ZonePortal proxy accounts, and owner-managed runtimes copied from verified source deployments. Activates at T10. (by @TanishkGoyal, [#7080](https://github.com/tempoxyz/tempo/pull/7080))
- Updated the canonical Zone Portal, Messenger, and Verifier runtime bytecode installed by the T10 hardfork. (by @TanishkGoyal, [#7080](https://github.com/tempoxyz/tempo/pull/7080))
