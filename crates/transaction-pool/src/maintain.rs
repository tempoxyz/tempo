...
trait ChainTransactionHashes {
    ...
    fn transaction_hashes(&self) -> impl Iterator<Item = &TxHash> + '_;
}
...
mod tests {
    ...
    #[test]
    fn chain_transaction_hashes_returns_mined_hashes() {
        ...
        let hashes: Vec<_> = chain.transaction_hashes().copied().collect();
