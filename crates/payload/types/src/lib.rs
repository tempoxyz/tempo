...
pub struct TempoBuiltPayload {
    ...
    /// EIP-2718 transaction encodings produced while computing payload roots.
    transaction_encodings: Option<Vec<Bytes>>,
...
pub struct TempoExecutionData {
    ...
    /// EIP-2718 transaction encodings produced during local payload building.
    #[serde(skip)]
    pub transaction_encodings: Option<Vec<Bytes>>,
}
