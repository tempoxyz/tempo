//! AWS Nitro verification with caller-supplied gas accounting.
...
pub const BASE_GAS: u64 = 40_000;
pub const SIGNATURE_GAS: u64 = 150_000;
...
pub const AWS_NITRO_ROOT_DER: &[u8; 533] = &alloy_primitives::hex!(
...
pub fn verify_attestation_with_root<E>(
    document: &[u8],
    block_timestamp: u64,
    root_der: &[u8],
    mut charge_gas: impl FnMut(u64) -> Result<(), E>,
) -> Result<Option<NitroAttestation>, E> {
