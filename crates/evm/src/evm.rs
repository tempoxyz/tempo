    ...
    fn test_tip20_full_evm_records_storage_actions_with_fees() {
        for hardfork in hardforks_for_storage_action_recording() {
            ...
            let mut expected = vec![
                ...
                StorageAction::Sstore(PATH_USD_ADDRESS, fee_manager_balance_slot, max_fee_spending),
                ...
                StorageAction::Sstore(PATH_USD_ADDRESS, sender_balance_slot, sender_after_transfer),
                ...
                StorageAction::Sstore(PATH_USD_ADDRESS, recipient_balance_slot, transfer_amount),
                ...
                StorageAction::Sload(PATH_USD_ADDRESS, fee_manager_balance_slot, max_fee_spending),
                // SSTORE balances[FeeManager]: leave actual spent fee in FeeManager custody.
                StorageAction::Sstore(PATH_USD_ADDRESS, fee_manager_balance_slot, actual_spending),
                // SLOAD balances[sender]: read sender before crediting unused fee refund.
                StorageAction::Sload(PATH_USD_ADDRESS, sender_balance_slot, sender_after_transfer),
                // SSTORE balances[sender]: refund unused fee.
                StorageAction::Sstore(PATH_USD_ADDRESS, sender_balance_slot, sender_after_refund),
            ...
            if hardfork == latest_available_hardfork() {
