...
use tempo_precompiles::{
    ADDRESS_REGISTRY_ADDRESS, NITRO_ATTESTATION_VERIFIER_ADDRESS, NONCE_PRECOMPILE_ADDRESS,
    PATH_USD_ADDRESS, SIGNATURE_VERIFIER_ADDRESS, STABLECOIN_DEX_ADDRESS,
...
pub(crate) fn fixture_from_seeded_db(seeded: CacheDB<EmptyDB>) -> ExecutionFixture {
    ...
    for address in [
        ...
        NITRO_ATTESTATION_VERIFIER_ADDRESS,
