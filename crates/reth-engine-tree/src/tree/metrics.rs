...
impl EngineApiMetrics {
    ...
    pub fn record_block_execution<R>(
        ...
        self.executor
            .gas_per_second
            .set(gas_used as f64 / execution_secs);
        ...
        self.executor
            .accounts_updated_histogram
            .record(accounts as f64);
        self.executor
            .storage_slots_updated_histogram
            .record(storage_slots as f64);
        self.executor
            .bytecodes_updated_histogram
    ...
    pub fn record_transaction_execution(&self, elapsed: Duration) {
        self.executor
            .transaction_execution_histogram
            .record(elapsed);
    }
}
...
impl ForkchoiceUpdatedMetrics {
    ...
    pub(crate) fn update_response_metrics(
        ...
        if let Some(prev_finish) = self.latest_finish_at {
            self.time_between_forkchoice_updated
                .record(start - prev_finish);
        }
        ...
        if has_attrs {
            self.forkchoice_with_attributes_updated_messages
                .increment(1);
        }
        ...
        if let Some(latest_new_payload_at) = latest_new_payload_at.take() {
            self.new_payload_forkchoice_updated_time_diff
                .record(start - latest_new_payload_at);
        }
    }
}
...
impl GasBucketMetrics {
    fn record(&self, gas_used: u64, elapsed: Duration) {
        ...
        self.buckets[idx]
            .new_payload_gas_bucket_latency
            .record(elapsed);
        self.buckets[idx]
