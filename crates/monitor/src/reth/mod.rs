//! Reth ExEx adapter for finalized-block tempo monitoring.
//!
...
pub use exex::{MonitorExExConfig, RethFinishedHeightSink, run_monitor_exex};
...
/// ExEx identifier used by the tempo monitor.
pub const EXEX_ID: &str = "tempo-monitor";
