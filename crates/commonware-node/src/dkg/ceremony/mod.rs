...
use crate::{
    ...
    dkg::{HardforkRegime, ceremony::tree::TreeOfDealings},
};
    ...
    TSender: Sender<PublicKey = PublicKey>,
{
    ...
    pub(super) fn finalize(
        ...
        let new_role = if let Some(player_me) = self.player_me.clone() {
            let my_index = self
                .players_indexed
    ...
    //     let (result, disqualified) = self.tree_of_dealings.finalize();
