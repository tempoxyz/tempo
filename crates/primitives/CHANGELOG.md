...
- Implemented TIP-1093 by extending the expiring nonce validity window to five minutes and the replay-protection ring to 3,000,000 entries at T10 activation. (by @TanishkGoyal, [#7080](https://github.com/tempoxyz/tempo/pull/7080))
