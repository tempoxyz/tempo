...
//!
//! Use with `#[serde(with = "tempo_primitives::serde_rlp")]` on any field implementing
//! both Serde and RLP serialization. Binary deserialization requires exactly one RLP value
