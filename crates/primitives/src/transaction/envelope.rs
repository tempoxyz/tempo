...
>>>>>>> f174511 (feat(primitives): add AA Tx Type)
use alloy_consensus::{
...
=======
            TempoTxType::AA => return Err(UnsupportedTransactionTypeEip4844),
...
impl From<Signed<TxAA>> for TempoTxEnvelope {
    fn from(value: Signed<TxAA>) -> Self {
        Self::AA(value)
    }
}
