...
/// Encodes the EIP-1014 preimage for the canonical cross-chain recovery wallet.
pub fn multisig_account_create2_preimage(
    account_salt: B256,
) -> [u8; MULTISIG_ACCOUNT_CREATE2_PREIMAGE_LEN] {
...
impl MultisigConfig {
    ...
    pub fn derive_account(&self) -> Result<Address, MultisigConfigError> {
        ...
        let input = multisig_account_create2_preimage(account_salt);
