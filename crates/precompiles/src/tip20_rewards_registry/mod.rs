...
use crate::{
    ...
    storage::{
        ContractStorage, PrecompileStorageProvider, Slot, StorageOps, VecSlotExt,
        slots::mapping_slot,
    },
...
impl<'a, S: PrecompileStorageProvider> TIP20RewardsRegistry<'a, S> {
    ...
    pub fn push_stream_ending_at_timestamp(
        ...
        type StreamsEndingAt = Slot<Vec<Address>, Field1Slot>;

        StreamsEndingAt::push(self.storage(), address)?;
