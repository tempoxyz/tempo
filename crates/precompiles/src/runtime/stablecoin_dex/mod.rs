...
pub use crate::contracts::stablecoin_dex::{IStablecoinDEX, IStablecoinDEX::prelude::*};
pub use orderbook::{
...
use crate::{
    ...
    tip20::{ITIP20::traits::*, TIP20Token, is_tip20_prefix, validate_usd_currency},
...
mod tests {
    ...
    fn test_compound_policy_non_escrow_token_direction() -> eyre::Result<()> {
        ...
        StorageCtx::enter(&mut storage, || {
            ...
            let mut quote = TIP20Token::from_address(quote_addr)?;
            quote.change_transfer_policy_id(admin, compound_id)?;
