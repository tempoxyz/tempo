...
pub use IRolesAuth::Error as RolesAuthError;
pub use IRolesAuth::Event as RolesAuthEvent;
pub use ITIP20::Error as TIP20Error;
pub use ITIP20::Event as TIP20Event;
