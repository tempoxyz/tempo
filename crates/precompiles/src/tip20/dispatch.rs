...
impl Precompile for TIP20Token {
    fn call(&mut self, calldata: &[u8], msg_sender: Address) -> PrecompileResult {
        ...
        dispatch!(
            ...
            TIP20Call::TIP20(ITIP20Calls::paused(_)) => metadata::<ITIP20::pausedCall>(|| self.paused()),
            ...
            TIP20Call::TIP20(ITIP20Calls::PAUSE_ROLE(call)) => view(call, |_| Ok(Self::pause_role())),
            TIP20Call::TIP20(ITIP20Calls::UNPAUSE_ROLE(call)) => {
                view(call, |_| Ok(Self::unpause_role()))
            },
            TIP20Call::TIP20(ITIP20Calls::ISSUER_ROLE(call)) => view(call, |_| Ok(Self::issuer_role())),
            ...
            TIP20Call::TIP20(ITIP20Calls::changeTransferPolicyId(call)) => mutate_void(call, msg_sender, |s, c| {
            ...
            TIP20Call::TIP20(ITIP20Calls::completeQuoteTokenUpdate(call)) => mutate_void(call, msg_sender, |s, c| {
            ...
            TIP20Call::TIP20(ITIP20Calls::transferFromWithMemo(call)) => mutate(call, msg_sender, |sender, c| {
            ...
            TIP20Call::RolesAuth(IRolesAuthCalls::hasRole(call)) => view(call, |c| self.has_role(c)),
