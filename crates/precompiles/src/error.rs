...
use tempo_contracts::precompiles::{
    AccountKeychainError, FeeManagerError, NonceError, RolesAuthError,
    SignatureVerificationError, StablecoinDEXError, TIP20FactoryError, TIP403RegistryError,
...
pub enum TempoPrecompileError {
    ...
    /// Error from signature verification precompile
...
impl TempoPrecompileError {
    ...
    pub fn into_precompile_result(self, gas: u64) -> PrecompileResult {
        let bytes = match self {
            ...
            Self::SignatureVerificationError(e) => e.abi_encode().into(),
            Self::OutOfGas => {
...
pub fn error_decoder_registry() -> TempoPrecompileErrorRegistry {
    ...
    add_errors_to_registry(
        &mut registry,
        TempoPrecompileError::SignatureVerificationError,
    );
