...
use tempo_contracts::precompiles::{
    AccountKeychainError, AddrRegistryError, BlockTransferError, FeeManagerError, NonceError,
...
impl TempoPrecompileError {
    ...
    pub fn into_precompile_result(self, gas: u64, reservoir: u64) -> PrecompileResult {
        let bytes = match self {
            ...
            Self::BlockTransferError(e) => e.abi_encode().into(),
            Self::OutOfGas => {
...
pub fn error_decoder_registry() -> TempoPrecompileErrorRegistry {
    ...
    add_errors_to_registry(&mut registry, TempoPrecompileError::BlockTransferError);
