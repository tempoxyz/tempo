...
impl TIP403Registry {
    ...
    pub(crate) fn check_receive_policy(
        ...
        if !self.is_authorized_configured_simple(
    ...
    /// Authorization for receive policies with an immutable cached simple policy type.
    fn is_authorized_configured_simple(
        &self,
        policy_id: u64,
        user: Address,
        policy_type: u8,
