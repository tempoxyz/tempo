...
fn main() {
    ...
    let zone_addr = TempoAddress::with_zone(
        address!("742d35CC6634c0532925a3B844bc9e7595F2Bd28"),
        1,
    );
    ...
    println!("Parsed:  {} (zone: {:?})", parsed.address(), parsed.zone_id());

    // Validate
    assert!(TempoAddress::validate("tempo1qp6z6dwvvc6vq5efyk3ms39une6etu4a9qtj2kk0"));
