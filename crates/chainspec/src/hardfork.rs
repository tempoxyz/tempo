...
impl TempoHardfork {
    ...
    pub const fn gas_existing_nonce_key(&self) -> u64 {
        match self {
            Self::Genesis | Self::T0 | Self::T1 | Self::T1A => crate::spec::TEMPO_T1_EXISTING_NONCE_KEY_GAS,
    ...
    pub const fn gas_new_nonce_key(&self) -> u64 {
        match self {
            Self::Genesis | Self::T0 | Self::T1 | Self::T1A => crate::spec::TEMPO_T1_NEW_NONCE_KEY_GAS,
