...
function buildMetricRows(summary) {
  ...
  return [
    ...
    { label: 'Builder Non-empty Avg TPS', baseline: fmtVal(b.builder_tps, '', 0), feature: fmtVal(f.builder_tps, '', 0), change: fmtChange(c.builder_tps) },
    { label: 'Validator Non-empty Avg TPS', baseline: fmtVal(b.validation_tps, '', 0), feature: fmtVal(f.validation_tps, '', 0), change: fmtChange(c.validation_tps) },
