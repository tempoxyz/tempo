...
const BUILDER_DETAIL_ROWS = [
  ...
  ['Expected Validation Reverts', 'builder_expected_validation_reverts', v => fmtVal(v, 0)],
  ['Expired Tx Reverts', 'builder_valid_before_reverts', v => fmtVal(v, 0)],
  ['Expiring Nonce Replay Reverts', 'builder_expiring_nonce_replay_reverts', v => fmtVal(v, 0)],
  ['Expiring Nonce Set Full Reverts', 'builder_expiring_nonce_set_full_reverts', v => fmtVal(v, 0)],
  ['Insufficient Funds Reverts', 'builder_insufficient_funds_reverts', v => fmtVal(v, 0)],
