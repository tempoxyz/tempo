...
async function main() {
  ...
  assert.ok(suite, 'usage: node bench-results/sload-128-20260924/analyze.cjs NATIVE_SUITE_DIR');
  ...
  const lines = ['# 128-SLOAD history-dependent bloat rerun', '',
    ...
    '| Workload | Builder execution Mgas/s | Follower execution Mgas/s | Chain Mgas/s |',
    '| --- | ---: | ---: | ---: |'];
  ...
  lines.push('', '## History coverage and correctness', '',
